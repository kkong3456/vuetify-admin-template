...
const jisaNetIncreaseUrl='http://172.21.220.97/api/net/jisa.json/?prod=무선&bonbu=북부고객본부&kind=net' 
const jisaNetIncreaseUrl2='http://172.21.220.97/api/net/jisa.json/?prod=무선&bonbu=동부고객본부&kind=net' 
...
export default {
  ...
  components:{
    name:'JisaInternetNetIncreaseLineChart'
  },
  ...
  async created () {
    await axios.all(
      [
        axios.get(jisaNetIncreaseUrl),
        axios.get(jisaNetIncreaseUrl2),
      ]
