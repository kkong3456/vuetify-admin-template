...
//const jisaHjUrl='http://172.21.220.97/api/net/jisa.json/?prod=미디어&bonbu=북부고객본부&kind=end' 
const jisaNetIncreaseUrl2='http://172.21.220.97/api/net/jisa.json/?prod=미디어&bonbu=동부고객본부&kind=net' 
