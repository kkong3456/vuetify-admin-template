...
const jisaNetHjUrl='http://172.21.220.97/api/net/jisa.json/?prod=미디어&bonbu=북부고객본부&kind=end' 
const jisaNetHjUrl2='http://172.21.220.97/api/net/jisa.json/?prod=미디어&bonbu=동부고객본부&kind=end' 
...
export default {
  ...
  async created () {
    await axios.all(
      [
        axios.get(jisaNetHjUrl),
        axios.get(jisaNetHjUrl2),
      ]
