...
const jisaHjUrl='http://172.21.220.97/api/net/jisa.json/?prod=무선&bonbu=북부고객본부&kind=end' 
const jisaHjUrl2='http://172.21.220.97/api/net/jisa.json/?prod=무선&bonbu=동부고객본부&kind=end' 
