...
const jisaHjUrl='http://172.21.220.97/api/net/jisa.json/?prod=미디어&kind=end&bonbu='
...
export default {
  ...
  async created () {
    await axios.get(jisaHjUrl+'북부고객본부').then((res,err)=>{
  ...
  methods: {  
    async changeBonbu(bonbuName){
      ...
      await axios.get(jisaHjUrl+bonbuName).then((res)=>{
        this.bonbuNetIncreaseData=res.data.results;
    ...
    getDesserts(bonbuName){
      ...
      if(bonbuName==='북부고객본부' || bonbuName==='동부고객본부' ||  bonbuName==='전남/전북고객본부'){
        ...
        let netHjLastMonth=yyy.last.firstJisa[1]+yyy.last.secondJisa[1]+yyy.last.thirdJisa[1]+yyy.last.fourthJisa[1]+yyy.last.fifthJisa[1];
        let netHjThisMonth=yyy.this.firstJisa[1]+yyy.this.secondJisa[1]+yyy.this.thirdJisa[1]+yyy.this.fourthJisa[1]+yyy.this.fifthJisa[1];
        let netHjDiff=((netHjThisMonth-netHjLastMonth)/netHjLastMonth*100).toFixed(1);
      
        this.$emit('netHjLastMonth',netHjLastMonth);
        this.$emit('netHjThisMonth',netHjThisMonth);
        this.$emit('netHjDiff',netHjDiff);
      }
      ...
      if(bonbuName==='강남고객본부' || bonbuName==='충남/충북고객본부' ||  bonbuName==='대구/경북고객본부'){
        ...
        //상위컴포넌트에 전월/금월/증감율 데이터를 넘긴다.
        let netHjLastMonth=yyy.last.firstJisa[1]+yyy.last.secondJisa[1]+yyy.last.thirdJisa[1]+yyy.last.fourthJisa[1]+yyy.last.fifthJisa[1]+yyy.last.sixthJisa[1];
        let netHjThisMonth=yyy.this.firstJisa[1]+yyy.this.secondJisa[1]+yyy.this.thirdJisa[1]+yyy.this.fourthJisa[1]+yyy.this.fifthJisa[1]+yyy.this.sixthJisa[1];
        let netHjDiff=((netHjThisMonth-netHjLastMonth)/netHjLastMonth*100).toFixed(1);
      ...
      if(bonbuName==='서부고객본부' || bonbuName==='부산/경남고객본부'){
        ...
        //상위컴포넌트에 전월/금월/증감율 데이터를 넘긴다.
        let netHjLastMonth=yyy.last.firstJisa[1]+yyy.last.secondJisa[1]+yyy.last.thirdJisa[1]+yyy.last.fourthJisa[1]+yyy.last.fifthJisa[1]+yyy.last.sixthJisa[1]+yyy.last.seventhJisa[1];
        let netHjThisMonth=yyy.this.firstJisa[1]+yyy.this.secondJisa[1]+yyy.this.thirdJisa[1]+yyy.this.fourthJisa[1]+yyy.this.fifthJisa[1]+yyy.this.sixthJisa[1]+yyy.this.seventhJisa[1];
        let netHjDiff=((netHjThisMonth-netHjLastMonth)/netHjLastMonth*100).toFixed(1);
