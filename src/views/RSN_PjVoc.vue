      ...
      >
        ...
        >
          ...
          >
            ...
            <v-card-content>
              <bonbu-tv-internet-pj-voc-cloud
                ref="changeBonbu7"
            ...
            <template v-slot:activator="{on,attrs}">
              ...
              >
                <p class="text-h6 text-center">
                  [{{ selectedBonbu.substring(0,2) }} -  VOC 누적현황 ]
                </p>
              </span>
            </template>
...
import BonbuTvInternetPjVocCloud from '@/components/wordcloud/BonbuTvInternetPjVocCloud'
import BonbuMobilePjVocCloud from '@/components/wordcloud/BonbuMobilePjVocCloud'
